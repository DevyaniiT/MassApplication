...
function change(newType, Xaxisvalue, actualHeightData, threshold, Hightvalue, Groupvalue, Colorvalue, Datevalue, Highvalue, Lowvalue, Openvalue, Closevalue, xvll, hvll, gvll, cvll, dval, highvll, lowvll, openvll, closevll, chartId) {
    ...
    //checkChartValue(kpiProperty["legendColor"], kpiProperty["legendFontSize"], kpiProperty["legendFontName"], kpiProperty["legendAlign"], kpiProperty["legendPosition"], kpiProperty["legendStyle"], kpiProperty["legendShow"], kpiProperty["xAxisFontSize"], kpiProperty["yAxisFontSize"], kpiProperty["AxisShow"], kpiProperty["gridLinesShow"], kpiProperty["y_showtitle"], kpiProperty["y_titlename"], kpiProperty["x_showtitle"], kpiProperty["x_titlename"], kpiProperty["y_color"], kpiProperty["y_fontfamily"], kpiProperty["y_fontsize"], kpiProperty["y_fontstyle"], kpiProperty["y_align"], kpiProperty["x_color"], kpiProperty["x_fontfamily"], kpiProperty["x_fontsize"], kpiProperty["x_fontstyle"], kpiProperty["x_align"], kpiProperty["y_label_color"], kpiProperty["x_label_color"], kpiProperty["y_label_fontfamily"], kpiProperty["x_label_fontfamily"], kpiProperty["y_label_fontsize"], kpiProperty["x_label_fontsize"], kpiProperty["y_label_fontstyle"], kpiProperty["x_label_fontstyle"], kpiProperty["y_label_align"], kpiProperty["x_label_align"]);
